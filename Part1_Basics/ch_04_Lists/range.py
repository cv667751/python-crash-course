...
# even_numbers=list(range(2, 11, 2)) list even numbers between 1 and 10. 
# this list starts with 2 and adds 2  until it reaches end of list
# ** for exponents
...
# 4-4 One Million but changed to Fifty: 
# Make a list of the numbers from one to one fifty, and 
