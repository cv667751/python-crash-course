...
# 4-10 Slices: 
family_Names = ['Crystal', 'Rey', 'Mario', 'Elvira', 
                'Mayito', 'Tiburon', 'Isabel']
print(family_Names)

# Print the message The first three items in the list are: 
# Then use a slice to print the first three itmes.
print("The first three items in the list are: ")
print(family_Names[0:3])
print(family_Names[:3])

# Print the message Three items from the middle of the list are:. 
# Then usea slice to print the three items from the middle of the list
...
# 4-11 Start with program 4-1 page 56. Make a copy of the list of pizzas, and 
...
# Print the message My favorite pizzas are: and 
...
for myList in pizza_places[0:4]:
    print(myList)
# Print the message My friend's favortie pizzas are: and 
...
#4-12 All versions of foods.py in this section have avodied using for loops 
