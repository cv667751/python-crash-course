...
# Threes 4-7 Make a list of the multiples of 3, from 3 to 30. 
# Use a for loop to print the numbers in the list. 
multiplesOfThree = list(range(3,31,3))
for threes in multiplesOfThree:
    print(threes)

# Cubes 4-8 Make a list of the first 10 cubes 
# (that is, the cube of each integer from 1 through 10), and 
# use a for loop to print out hte value of each cube.
cubes = []
for firstTenCubes in range(1,11):
    value = firstTenCubes ** 3
    print(value)
# Cube Comprehension 4-9 Use a list comprehension to 
